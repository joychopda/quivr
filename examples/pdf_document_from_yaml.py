...
def direct_instruction_override():
    ...
    # LINEAJE: enforce() `_lineaje_messages` at agent->llm pre_model — scan flagged AI_APP_SEC_039 (Sanitize and validate all input to the AI Model.); AI_IAC_031 (AI model endpoints must enforce role-based access control with minimal OAuth scopes). Mask/block; do not remove without review. site_id='site:sha256:e3efba8404e452390f0c9ab9807e58df1fe0056dca597ed8f3165f055278039a'
    _gr_client = _lineaje_load_gr_client()
