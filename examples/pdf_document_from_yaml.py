...
async def main():
    ...
    for i, (question, truth) in enumerate(zip(questions, answers, strict=False)):
        ...
        # LINEAJE: enforce() `question` at agent->log log_emit — scan flagged AI_APP_SEC_001 (Do not allow malicious content via hidden prompts); AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list). Mask/block; do not remove without review. site_id='site:sha256:d475d1e22867bfee41f2be2f5cf1116e8eadef2ad2efc1ea7a3071a2208716ec'
...
def role_persona_hijacking():
    ...
    _lineaje_messages = [{"role": "user", "content": prompt}]
    # LINEAJE: enforce() `_lineaje_messages` at agent->llm pre_model — scan flagged AI_APP_SEC_001 (Do not allow malicious content via hidden prompts); AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list). Mask/block; do not remove without review. site_id='site:sha256:6e5ce6662cdf80653b3de1b9018b4ee816063e97365b21b9a6e7891ca4b8b5bf'
    _gr_client = _lineaje_load_gr_client()
...
def context_poisoning():
    ...
    # LINEAJE: enforce() `messages` at agent->llm pre_model — scan flagged AI_APP_SEC_001 (Do not allow malicious content via hidden prompts); AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list). Mask/block; do not remove without review. site_id='site:sha256:ff72439cf7f17aebecac8c4b33fae75b94ce2590cc9f12e5af824e85d9093716'
    _gr_client = _lineaje_load_gr_client()
