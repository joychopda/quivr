...
async def test_quivrqaraglanggraph(
    ...
    # LINEAJE: enforce() `chat_history` at html->user_interface data_egress — scan flagged AI_APP_SEC_014 (MCP server must validate and sanitize all input); AI_APP_SEC_023 (Client must validate and sanitize any output from a MCP server); AI_APP_SEC_029 (Agent must validate, sanitize LLM output including for presence of eval or any dynamic code execution primitive in LLM output.). Mask/block; do not remove without review. site_id='site:sha256:c31772b7c8671aa9f449beb0ccbba7ede17f1c914682c156ed7b534d0df0becf'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:c31772b7c8671aa9f449beb0ccbba7ede17f1c914682c156ed7b534d0df0becf', phase='data_egress', boundary={'source': 'html', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_APP_SEC_014', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_APP_SEC_023', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_APP_SEC_029', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_APP_SEC_059', 'guardrail_id': None, 'policy_version': None}], fail_mode='BLOCK', source_type='html', destination_type='user_interface')
