...
def test_parse_chunk_response_nofunc_calling():
    ...
    for i in range(10):
        # LINEAJE: enforce() `rolling_msg` at tool->user_interface data_egress — scan flagged AI_APP_SEC_029 (Agent must validate, sanitize LLM output including for presence of eval or any dynamic code execution primitive in LLM output.). Mask/block; do not remove without review. site_id='site:sha256:7439a17084c3a1bffef82323e53c80623f70637204c5f72951320b672f5308a5'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:7439a17084c3a1bffef82323e53c80623f70637204c5f72951320b672f5308a5', phase='data_egress', boundary={'source': 'tool_result', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_APP_SEC_029', 'guardrail_id': None, 'policy_version': None}], fail_mode='BLOCK', source_type='tool', destination_type='user_interface')
        rolling_msg = _gr_client.enforce(_gr_site, rolling_msg, content_type='text/plain')
