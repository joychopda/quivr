...
class Brain:
    ...
    * Stream the answer to the question.
    ...
    def print_info(self):
        ...
        # LINEAJE: enforce() `panel` at agent->log log_emit — scan flagged AI_APP_SEC_001 (Do not allow malicious content via hidden prompts); AI_APP_SEC_002 (Do not allow malicious content via encoded prompts); AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:845dd4959d03f2dce6585f53bef1241c8924547cacb9d53a311946e2b662a2c3'
        _gr_client = _lineaje_load_gr_client()
