...
class QuivrQARAGLangGraph:
    ...
    def invoke_structured_output(
        ...
        try:
            ...
            # LINEAJE: enforce() `prompt` at agent->llm pre_model — scan flagged AI_IAC_031 (AI model endpoints must enforce role-based access control with minimal OAuth scopes). Mask/block; do not remove without review. site_id='site:sha256:94e66e40112a220834f5532fb9c6167ca6478126d0adbf5379657658b404b6be'
            _gr_client = _lineaje_load_gr_client()
