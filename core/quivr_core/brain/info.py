...
class BrainInfo:
    ...
    def to_tree(self):
        ...
        # LINEAJE: enforce() `tree` at agent->user_interface data_egress — scan flagged AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list); AI_IAC_014 (A user must authenticate before accessing the AI Agent.); AI_IAC_023 (Chatbot and AI interfaces must disclose AI identity to the user). Mask/block; do not remove without review. site_id='site:sha256:a62e2789723c9834440bac4997fbedb45cd9274e87129b445cc07cb5bbe0193e'
