...
"""
    # LINEAJE: enforce() `prompt` at agent->llm pre_model — scan flagged AI_APP_SEC_001 (Do not allow malicious content via hidden prompts); AI_APP_SEC_002 (Do not allow malicious content via encoded prompts); AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:c57635566f9f49475b8441061deb289216eed767ee339dee0a2bfabf31374b47'
