...
class Brain:
    ...
    * Stream the answer to the question.
    ...
    def print_info(self):
        ...
        # LINEAJE: enforce() `panel` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_023 (Client must validate and sanitize any output from a MCP server); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list). Mask/block; do not remove without review. site_id='site:sha256:0da061d04939889dbbc2f5012bbfc3fbfce38836624687d7b31b92536d7987f7'
        _gr_client = _lineaje_load_gr_client()
