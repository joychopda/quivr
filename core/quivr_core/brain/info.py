...
class BrainInfo:
    ...
    def to_tree(self):
        ...
        # LINEAJE: enforce() `tree` at agent->user_interface data_egress — scan flagged AI_IAC_SEC_020 (Restrict AI agents to an explicit tool allow list.). Mask/block; do not remove without review. site_id='site:sha256:a62e2789723c9834440bac4997fbedb45cd9274e87129b445cc07cb5bbe0193e'
