...
def _mcp_request(server_url: str, payload: Dict[str, Any], token: str | None = None) -> Dict[str, Any]:
    ...
    # LINEAJE: enforce() `resp` at api->agent post_tool — scan flagged AI_IAC_015 (Enforce URL allowlists for agent fetches, tools, and outbound HTTP.). Mask/block; do not remove without review. site_id='site:sha256:b242c70d075e287cfa421f6aeefd90fccfe5471f682eddef696caae31b15383c'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:b242c70d075e287cfa421f6aeefd90fccfe5471f682eddef696caae31b15383c', phase='post_tool', boundary={'source': 'external_endpoint', 'sink': 'agent_message'}, candidate_policies=[{'policy_id': 'AI_IAC_015', 'guardrail_id': None, 'policy_version': None}], fail_mode='ALLOW_WITH_AUDIT', source_type='api', destination_type='agent')
    resp = _gr_client.enforce(_gr_site, resp, content_type='application/json', variable_name='resp', source_file=__file__, before_line=24)
    return resp.json()
