...
def _mcp_request(server_url: str, payload: Dict[str, Any], token: str | None = None) -> Dict[str, Any]:
    ...
    # LINEAJE: enforce() `resp` at api->agent post_tool — scan flagged AI_APP_SEC_071 (Enforce chemical, biological, radiological, or nuclear (CBRN) threat prevention safeguards in AI-enabled systems); AI_IAC_015 (Enforce URL allowlists for agent fetches, tools, and outbound HTTP.); AI_IAC_018 (Enforce cryptographically verified user-to-agent binding for every request.). Mask/block; do not remove without review. site_id='site:sha256:b242c70d075e287cfa421f6aeefd90fccfe5471f682eddef696caae31b15383c'
