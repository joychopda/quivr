...
def test_model_supports_function_calling():
    ...
    _lineaje_payload = "ollama3"
    # LINEAJE: enforce() `_lineaje_payload` at html->user_interface data_egress — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:f6cdd36e47643581befdc9736c4a1acea2a238887bc00c5f963ad06f122f6e73'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:f6cdd36e47643581befdc9736c4a1acea2a238887bc00c5f963ad06f122f6e73', phase='data_egress', boundary={'source': 'html', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='html', destination_type='user_interface')
    _lineaje_payload = _gr_client.enforce(_gr_site, _lineaje_payload, content_type='text/html')
    assert model_supports_function_calling(_lineaje_payload) is False
